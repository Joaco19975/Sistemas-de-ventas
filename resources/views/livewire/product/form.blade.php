...
<div class="row">
            ...
            <div class="col-sm-12 col-md-4">
                <div class="form-group">
                    <label>Codigo</label>
                    <input type="text" wire:model.lazy="barcode" class="form-control" placeholder="ej:  026598">
            ...
            <div class="col-sm-12 col-md-4">
                <div class="form-group">
                    <label>Cost</label>
                    <input type="text" data-type='currency' wire:model.lazy="cost" class="form-control" placeholder="ej: 0.0">
            ...
            <div class="col-sm-12 col-md-4">
                <div class="form-group">
                    <label>Alerts (inventario minimo)</label>
            ...
            <div class="col-sm-12 col-md-4">
                <div class="form-group">
                    ...
                    <select wire:model='categoryid' class="form-control" aria-label="label for the select">
