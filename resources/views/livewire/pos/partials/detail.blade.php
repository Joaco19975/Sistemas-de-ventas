    ...
    <div class="connect-sorting-content">
        <div class="card simple-title-task ui-sortable-handle">
            <div class="card-body">
             ...
             @if($total > 0)
                <div class="table-responsive tblscroll" style="maz-height: 650px; overflow: hidden">
                       ...
                       @foreach($cart as $item) 
                        <tr>
                            <td class="text-center table-th">
                                ...
                                <span>
                                    <img src="{{ asset('storage/products/' . $item->attributes[0])}}" alt="Image" height="90" width="90" class="rounded">
                                </span>
                                @endif
                            </td>
